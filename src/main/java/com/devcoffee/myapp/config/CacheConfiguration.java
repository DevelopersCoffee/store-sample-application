package com.devcoffee.myapp.config;
...
public class CacheConfiguration {
        ...
        if (this.registration == null) { // if registry is not defined, use native discovery
            ...
            return () ->
                GlobalConfigurationBuilder
                    ...
                    .defaultCacheName("infinispan-StoreSampleApplication-cluster-cache")
                    .transport()
                    .defaultTransport()
                    .addProperty("configurationFile", jHipsterProperties.getCache().getInfinispan().getConfigFile())
                    .clusterName("infinispan-StoreSampleApplication-cluster")
                    .jmx()
    ...
    public InfinispanCacheConfigurer cacheConfigurer(JHipsterProperties jHipsterProperties) {
        ...
        return manager -> {
            ...
            Stream
                .of(
                    com.devcoffee.myapp.repository.UserRepository.USERS_BY_LOGIN_CACHE,
                    com.devcoffee.myapp.repository.UserRepository.USERS_BY_EMAIL_CACHE
                )
                .forEach(
                    cacheName ->
                        manager.defineConfiguration(
