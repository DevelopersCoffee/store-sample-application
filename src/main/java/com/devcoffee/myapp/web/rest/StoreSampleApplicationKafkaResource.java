...
@RestController
@RequestMapping("/api/store-sample-application-kafka")
public class StoreSampleApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(StoreSampleApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public StoreSampleApplicationKafkaResource(KafkaProperties kafkaProperties) {
